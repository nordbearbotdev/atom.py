...
class Client(discord.Client):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.limitedRoleID = 998664709530189895
        #Set this to your servers ID.
        self.serverID = 998305711354298509
...
client = Client()
#Set your token here
client.run('MTAyNjkxMTQxMTE4MTQ3Mzg2Mg.G76ooX.1Xy-VW09KV4h1XydC2N_-CUNWD-ET-lr2DL8S4')
